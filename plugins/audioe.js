...
cmd({
  ...
  try {
    if (!q) {
      return await reply("Please provide the number and text. Example: `.boom 100,hi`");
    }
    ...
    if (isNaN(count) || !text) {
      return await reply("Invalid format. Please use the format: `.boom 100,SUHAS-MD`");
    }
